...
namespace Robot_P16.Robot.composants.Servomoteurs
{
    ...
    {
        public const ActionServo GR_PLATEAU_TAQUET =
        ...
        public const ActionServo GR_PLATEAU_CRANHORAIRE =
        ...
        public const ActionServo GR_PLATEAU_CRANANTIHORAIRE =
        ...
        public const ActionServo GR_TRAPPE_OUVRIR =
    new ActionBuilder("ServoGR- ouvrir la trappe").BuildActionServo(Robot.robot.GR_SERVO_TRAPPE, ServoCommandTypes.ABSOLUTE_ROTATION, DonneesServo.ANGLE_GR_TRAPPE_OUVRIR);
        ...
        public const ActionServo GR_TRAPPE_FERMER =
