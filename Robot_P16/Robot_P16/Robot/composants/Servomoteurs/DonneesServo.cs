...
namespace Robot_P16.Robot.Composants.Servomoteurs
{
    ...
    public static class DonneesServo
    {
 	 ...
 	 public const float ANGLE_PR_ASCENSEURDROIT_MONTERUNITE = 195.58; //valeur inconnue et différente de l'aute ascenseur car systèmes physiques différents
 	 public const float ANGLE_PR_ASCENSEURDROIT_DESCENDREUNITE = -195.58;
